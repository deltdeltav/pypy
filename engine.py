...
def draw_tile_3d(screen, c, r, type, cam_x, cam_y, color_override=None):
    ...
    h = 20
    # --- ИСПРАВЛЕНИЕ: МЯГКИЕ ЦВЕТА ---
    if type == 'road': 
        top, side = (35, 35, 40), (20, 20, 25) # Темно-серый асфальт
    elif type == 'base': 
        top, side = (15, 15, 25), (5, 5, 10)
    else: 
        top, side = (30, 100, 30), (15, 70, 15) # Темная трава
    ...
    # УБРАНА яркая обводка. Оставил легкую темную для объема
    pygame.draw.polygon(screen, (0,0,0,30), pts_top, 1)
